...
public class TabelaHash {
    public static void main(String[] args) {
        ...
        Registro[] registros = new Registro[20000];
        ...
        for (int i = 0; i < 5; i++) {
            chavesBusca[i] = registros[random.nextInt(20000)];
        }
        ...
        medirBuscasETempoDobramento(tabelaDobramento7000000, chavesBusca, "tabelaDobramento7000000");
    ...
    public static void medirInsercoesETempo(FuncaoHash tabela, Registro[] registros, String tabelaNome) {
        ...
        System.out.println("Inserções na " + tabelaNome + ": " + 20000);
    ...
    public static void medirBuscasETempo(FuncaoHash tabela, Registro[] chavesBusca, String tabelaNome) {
        System.out.println("Buscas na " + tabelaNome + ": " + 20000);
